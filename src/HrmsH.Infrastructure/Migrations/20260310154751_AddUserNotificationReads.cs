        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationReads_UserId_NotificationType_NotificationKey",
                table: "UserNotificationReads",
                columns: new[] { "UserId", "NotificationType", "NotificationKey" },
                unique: true);
        }
